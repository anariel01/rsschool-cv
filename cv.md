...
### **E-mail:** annasergeeva29@ya.ru

### **Telegram:** [@anariel01](https://t.me/anariel01)
...
### "Hello, Name or World!" KATA from CODEWARS:
...
function hello(name) {
  ...
  const a = name.slice(0, 1).toUpperCase() + name.slice(1).toLowerCase();
...
### \*Irkutsk State University, _2023_

### \* HTML,CSS and JavaScript theory and simulators , _[HTML Academy](https://htmlacademy.ru) 2025_

### \*Complete course on React JS (Redux / Router / Tailwind CSS), _[Udemy](https://www.udemy.com/course/react-js-redux-router-tailwind-css/) 2025_
